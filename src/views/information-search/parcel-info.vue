    ...
    <div id="pop-road-selector" class="ol-layer">
      <div class="road-selector-pop">
        ...
        <div ref="roadTypeColorDiv" class="road-selector-color">
           <el-checkbox-group v-model="radio" v-show="value1==false">
                <el-checkbox label="1">快速路 <span class="lightGreen colorBox"></span></el-checkbox>
                <el-checkbox label="3">主干路<span  class="lightYellow colorBox"></span></el-checkbox>
                <el-checkbox label="6">次干路<span  class="lightRed colorBox"></span></el-checkbox>
                <el-checkbox label="9">支路  <span  class="blue  colorBox"></span></el-checkbox>
            </el-checkbox-group>
             <el-checkbox-group v-model="radio2" v-show="value1==true">
                <el-checkbox label="1">建成使用 <span class="lightGreen colorBox"></span></el-checkbox>
                <el-checkbox label="3">施工建设中<span  class="lightYellow colorBox"></span></el-checkbox>
                <el-checkbox label="6">规划道路<span  class="lightRed colorBox"></span></el-checkbox>
            </el-checkbox-group>
        </div>
      </div>
    </div>
      ...
      <div class="pop-summry-control">
        <div>
          <div class="pop-summry-control-title"> 
            ...
            <i class="el-icon-arrow-down"  @click="hideSummryPop"></i></div>
        </div>
      </div>
      <!--总体信息表格-->
      <div class="flex-div">
    ...
    <div id="pop-summry—collapse" class="ol-layer">
      <div class="pop-summry-control">
        <div>
          ...
          <i class="el-icon-arrow-up"  @click="showSummryPop"></i></div>
        </div>
      </div>
    </div>
  </div>
  ...
  methods: {
    ...
    initMap () {
      ...
      const vectorSource = new VectorSource({
        features: (new GeoJSON({ featureProjection: 'EPSG:3857' })).readFeatures(this.geoJsonList)
      });
    ...
    getRoadGeoJson: async function (vueObject) {
      try {
        ...
        let url = "http://106.14.106.138:7770/geoserver/Test/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=Test%3Aroad0714_view&maxFeatures=500000000&outputFormat=application%2Fjson";
